...
sed 's/<include>/<script\ type=\"text\/javascript\"\ src=\"cordova\.js\"><\/script><script\ type=\"text\/javascript\"\ src=\"js\/index.js\"><\/script><script\ type=\"text\/javascript\">app\.initialize();<\/script>/g' parse2.html > parse.html 
