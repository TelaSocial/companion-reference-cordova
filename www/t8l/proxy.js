...
var t8l = { 
    GOOGLE:1, JQUERY:2, STORE:3, JSONBLOB:4, 
    ...
    init: function (mode) { 
     	...
     	if(mode==this.JSONBLOB) { 
    		this.mode=this.JSONBLOB;
    		window.addEventListener("load", function () { 
    			t8l.callbackWhenLoaded();
    		} , false);
    	}  
    ...
    callbackWhenLoaded: function () { 
    	...
    	if(t8l.mode==t8l.JSONBLOB) { 
    		t8l.feeds.Feed=t8l_JSONBlob; 
    	} 
